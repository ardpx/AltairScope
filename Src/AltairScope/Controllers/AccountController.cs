...
namespace AltairScope.Controllers
{
	...
	{
		private UserDataServices _UserServices;
		//
		// GET: /Account/Login
		...
		public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
		{
			...
			if (ModelState.IsValid)
			{
				...
				DomainModels.User user = _UserServices.GetUserByName(WebAppContext.Current, model.UserName.ToLower());
